...
export function getActivityMessageLabel(message) {
    switch (message) {
...
function localizeInstallMessage(message, englishPrefix, chinesePrefix) {
...
function stripTrailingPeriod(message) {
...
export function getInstallTypeLabel(installType) {
    switch (installType) {
...
export function getJobAttemptEventLabel(event) {
    switch (event) {
