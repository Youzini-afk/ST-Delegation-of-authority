...
export interface StManagerControlConfig {
    enabled: boolean;
    manager_url: string;
...
export interface StManagerControlFormValues {
    enabled: boolean;
    managerUrl: string;
    controlKey: string;
}

export interface StManagerBackupSummary {
    backup_id: string;
    created_at?: string;
    total_files?: number;
}

export function normalizeStManagerControlConfig(value: unknown): StManagerControlConfig | null {
...
export function buildStManagerControlPayload(values: StManagerControlFormValues) {
    return {
...
export function renderStManagerControlSection(
    config: StManagerControlConfig | null,
    backups: StManagerBackupSummary[],
    busy: boolean,
): string {
