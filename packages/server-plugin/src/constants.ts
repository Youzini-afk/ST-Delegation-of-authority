...
export const MAX_STORAGE_BLOB_TRANSFER_BYTES = MAX_BLOB_BYTES;
export const MAX_PRIVATE_FILE_TRANSFER_BYTES = MAX_BLOB_BYTES;
export const MAX_HTTP_REQUEST_TRANSFER_BYTES = MAX_HTTP_BODY_BYTES;
export const MAX_HTTP_RESPONSE_TRANSFER_BYTES = MAX_HTTP_RESPONSE_BYTES;
export const MAX_DATA_TRANSFER_BYTES = Math.max(
