...
export const NATIVE_MIGRATION_MAX_COMPRESSED_BYTES = 12 * 1024 * 1024 * 1024;
export const NATIVE_MIGRATION_TRANSFER_CHUNK_BYTES = 4 * 1024 * 1024;
export const NATIVE_MIGRATION_MAX_UNCOMPRESSED_BYTES = 48 * 1024 * 1024 * 1024;
export const NATIVE_MIGRATION_MAX_ENTRY_COUNT = 300_000;
export const NATIVE_MIGRATION_MAX_PATH_BYTES = 1024;
export const NATIVE_MIGRATION_MAX_PATH_DEPTH = 32;
